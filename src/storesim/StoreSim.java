...
public class StoreSim {
    ...
    mcdo.sellItem(0); // mcdo earnings += 50
    mcdo.sellItem(50); // not sold
    watsons.sellItem("Soap"); // sold; watsons earnings += 65
    watsons.sellItem("Mouthwash"); // not sold
    mall.sellItem(i7); // (T-shirt)sold; supermall earnings += 200
    mall.sellItem(i3); // (Fried chicken) sold; supermall earnings += 70
