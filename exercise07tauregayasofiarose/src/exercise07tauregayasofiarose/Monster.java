...
public abstract class Monster implements Interactive {
    protected final String name, type, strongAgainst, weakAgainst; // change to protected
    protected int maxHP, hp, atk, def, xp, lvl; // change to protected
    ...
    public void interact() {
        ...
        System.out.println("Type of monster: " + type);
    }
}
